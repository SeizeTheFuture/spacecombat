...
class Game():
    ...
    def start_new_round(self):
        ...
        self.pause_game(f"Space Combat Round {self.round}", "Press 'Enter' to begin")
...
class Player(pygame.sprite.Sprite):
    ...
    def animate(self, speed):
        ...
        if self.image_index > len(self.animation_list):
            self.image_index = 0
        self.image = self.animation_list[int(self.image_index)]
...
#Set the window size based on the user's computer
